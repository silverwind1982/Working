...
static void usage()
{
   ...
   printf("   --set_upgrade:\n");
   printf("         sets the other slot as active.\n");
   printf("   --set_downgrade:\n");
   printf("         sets the other slot as active.\n");
   printf("   --dbg: <0|1>\n");
...
static int do_set_upgrade(void *p)
{
   int index = libabctl_getBootSlot();
   ...
   int ret = libabctl_setActive(index);

   return ret;
}

static int do_set_downgrade(void *p)
{
   int index = libabctl_getBootSlot();
...
opt_func_map opt_func_list[] = {
   ...
   {"--set_upgrade",  	(sizeof("--set_upgrade") - 1), &do_set_downgrade, 0},
   {"--set_downgrade",  (sizeof("--set_downgrade") - 1), &do_set_upgrade, 0},
